  ...
  return (
    <div className="p-16 min-h-screen bg-slate-900 text-slate-50">
      <div className="text-start">
        ...
        <h2>Get in Touch with Shortly</h2>
        <br />
      </div>
      ...
      <div>
        <p className="mb-8">
          ...
          support, or want to provide feedback, we&apos;re here to help.
        </p>
      ...
      <div>
        ...
        <ul className="pt-3 ml-6 font-medium text-lg">
          ...
          <li>
            2. <span className="font-bold">Pro Plan:</span> Within 24 hours
            (Priority Support)
          </li>
          <li>
            3. <span className="font-bold">Enterprise Plan:</span> Within 4
      ...
      <div>
        ...
        <ul className="pt-3 ml-6 font-medium text-lg">
          <li>
            If you encounter a malicious short URL or abuse of our service:
          </li>
          <li>
            Email:{" "}
            <Link
